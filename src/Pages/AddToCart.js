          ...
          <>
            ...
            >
              <Typography
                variant="h6"
                gutterBottom
                sx={{ fontWeight: "bold", color: "#712121" }}
              >
            ...
            >
              <div>
                <Scrollbars
                  style={{ width: 600, height: 500, color: "#FFD700" }}
                ...
                >
                  <ModalContent>
                    ...
                    <TextField
                      ...
                      helperText={
                        formErrors.unameError
                          ? "Please enter a valid name (for ex: John)"
                          : ""
                      }
                      disabled
                    />
          ...
          <>
            <Grid>
              ...
              <Typography
                variant="body2"
                gutterBottom
                sx={{ textAlign: "center", marginTop: "30px", color: "grey" }}
              >
